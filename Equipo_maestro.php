...
// Consulta SQL para obtener proyectos donde el maestro está invitado
$query = "SELECT id_proyecto, nombre, descripcion, logo FROM proyectos WHERE maestro_id = '$id_maestro'";
...
<div class="project-list">
    <?php while ($proyecto = pg_fetch_assoc($result)): ?>
        <div class="project-item">
            <img src="<?= $proyecto['logo'] ?>" alt="Logo del Proyecto" class="project-logo">
            <div class="project-info">
                <h4><?= $proyecto['nombre'] ?></h4>
                <p><?= substr($proyecto['descripcion'], 0, 100) ?>...</p>
                <a href="VerProyecto.php?id=<?= $proyecto['id_proyecto'] ?>" class="view-button">Ver Proyecto</a>
            </div>
        </div>
    <?php endwhile; ?>
</div>
