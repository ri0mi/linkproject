    ...
    ?>
        ...
        <div class="profile-info">
            ...
            if ($result && pg_num_rows($result) > 0) {
                ...
                echo "<li><strong>Contacto:</strong> " . htmlspecialchars($row['contacto']) . "</li>";
                echo "<li><strong>Carrera:</strong> " . htmlspecialchars($row['carrera']) . "</li>";
                echo "<li><strong>Laboratorio:</strong> " . htmlspecialchars($row['laboratorio']) . "</li>";
                echo "<li><strong>Horario:</strong> " . htmlspecialchars($row['horario']) . "</li>";
                echo "<li><strong>Habilidades:</strong> " . htmlspecialchars($row['habilidades']) . "</li>";
