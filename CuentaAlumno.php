...
<body>
    ...
    <div class="container mt-5">
        ...
        <form id="registroForm" action="guardar_alumno.php" method="POST">           
            ...
            <div class="mb-3">
                ...
                <input type="text" id="id_alumno" class="form-control" name="id_alumno" required maxlength="8" pattern=".{8}" title="El código debe tener exactamente 8 caracteres.">
            ...
            <div class="mb-3">
                ...
                <small id="correoError" class="error-message">Por favor ingresa un correo válido debe terminar con alumnos.udg.mx.</small>
            </div>
            <div class="mb-3">
    ...
    <script>
        document.getElementById('registroForm').addEventListener('submit', function(event) {
            ...
            const codigoInput = document.getElementById('id_alumno');
        ...
        const correoRegex = /^[a-zA-Z0-9._-]+@alumnos\.udg.mx$/; // Reemplaza "ejemplo.com" con el dominio que desees
        ...
        document.getElementById('id_alumno').addEventListener('input', function() {
